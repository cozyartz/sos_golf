...
4. The golfer resolves the URL to see the course, start time, player count, and
   approved next steps.
5. A future State of Stick identity session can claim a player slot, activate a
   round, and connect scoring, services, leagues, and Golf Agent context.
...
identity assignment, and consequential status changes require the future
State of Stick identity adapter.
