...
export function canViewPlayerData(requesterId: string | undefined, personId: string): boolean { return typeof requesterId === 'string' && requesterId.length > 0 && requesterId === personId; }
